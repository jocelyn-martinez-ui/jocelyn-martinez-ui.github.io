...
4. loopline-partnership-deck.pptx
   The editable presentation downloaded from the PowerPoint application tab.

Optional:

5. loopline-thumbnail.svg
   Editable vector source for the preview artwork. The website does not require
   this file, but it is useful if you want to revise or re-export the thumbnail.

Keep the filenames unchanged and retain your existing portfolio image files and
project folders. Because every new link is relative, the pages will work on
GitHub Pages without changing your repository name or domain.
